...
def seed_mock_data(session: Session) -> None:
    ...
    courses = [
        ...
        course("FIN", "350", "Mock Applied Finance Eligibility Lab", level=300),
        ...
        course("FIN", "410", "Mock Derivatives With Corequisite", level=400),
        course("FIN", "411", "Mock Derivatives Studio Corequisite", level=400),
        course("FIN", "450", "Mock Advanced Finance Capstone", level=400),
        course("ELEC", "100", "Mock Free Elective", level=100),
        course("FREE", "100", "Mock Unrestricted Exploration", level=100),
    ...
    sections = [
        ...
        section(
            "2024-fall-fin-300-002",
            "FIN-300",
            "2024-fall",
            "002",
            status=SectionStatus.OPEN,
            modality=SectionModality.IN_PERSON,
            instructor_display="Mock Near-Duplicate Instructor",
        ),
        section(
            "2024-fall-fin-300-afternoon",
            "FIN-300",
            "2024-fall",
            "AFT",
            status=SectionStatus.OPEN,
            modality=SectionModality.IN_PERSON,
            instructor_display="Mock Afternoon Instructor",
        ),
        section(
        ...
        section(
            "2024-fall-fin-403-online",
            "FIN-403",
            "2024-fall",
            "ONL",
            status=SectionStatus.OPEN,
            modality=SectionModality.ONLINE_SYNCHRONOUS,
            instructor_display="Mock Synchronous Online Instructor",
        ),
        section(
            "2025-spring-fin-350-001",
            "FIN-350",
            "2025-spring",
            "001",
            status=SectionStatus.OPEN,
    ...
    meetings = [
        ...
        section_meeting(
            "2024-fall-fin-300-afternoon-lecture-a",
            "2024-fall-fin-300-afternoon",
            MeetingType.LECTURE,
        ...
        section_meeting(
            "2024-fall-fin-300-afternoon-lecture-b",
            "2024-fall-fin-300-afternoon",
            MeetingType.LECTURE,
        ...
        section_meeting(
            "2024-fall-fin-403-002-lecture-a",
            "2024-fall-fin-403-002",
            MeetingType.LECTURE,
            day_of_week=DayOfWeek.TUESDAY,
        ...
        section_meeting(
            "2024-fall-fin-403-002-lecture-b",
            "2024-fall-fin-403-002",
            MeetingType.LECTURE,
            day_of_week=DayOfWeek.THURSDAY,
            start_time=time(11, 0),
        ...
        section_meeting(
            "2024-fall-fin-403-friday-lecture",
            "2024-fall-fin-403-friday",
            MeetingType.LECTURE,
            day_of_week=DayOfWeek.FRIDAY,
            start_time=time(10, 0),
        ...
        section_meeting(
            "2024-fall-fin-403-online-lecture",
            "2024-fall-fin-403-online",
            MeetingType.LECTURE,
            day_of_week=DayOfWeek.WEDNESDAY,
        ...
        section_meeting(
            "2025-spring-fin-350-001-lecture",
            "2025-spring-fin-350-001",
            MeetingType.LECTURE,
            day_of_week=DayOfWeek.MONDAY,
            start_time=time(13, 0),
    ...
    course_rules = [
        ...
        course_rule(
            "fin-350-prerequisite",
            "FIN-350",
            CourseRuleType.PREREQUISITE,
            "Mock FIN 350 projected prerequisite",
            description="Mock rule: complete Mock FIN 402 before FIN 350.",
        ),
        course_rule(
            "fin-410-corequisite",
            "FIN-410",
            CourseRuleType.COREQUISITE,
            "Mock FIN 410 studio corequisite",
            description="Mock rule: enroll in Mock FIN 411 as a corequisite.",
        ),
        course_rule(
            "fin-450-prerequisite",
            "FIN-450",
            CourseRuleType.PREREQUISITE,
            "Mock FIN 450 missing prerequisite",
            description="Mock rule: complete Mock ACTL 300 before FIN 450.",
        ),
        course_rule(
    ...
    expressions = [
        ...
        expression_node(
            "fin-350-prerequisite-root",
            "fin-350-prerequisite",
            CourseRuleExpressionNodeType.COMPLETED_COURSE,
            display_order=0,
            referenced_course_key="FIN-402",
            text_value="Mock FIN 350 waits on in-progress FIN 402.",
        ),
        expression_node(
            "fin-410-corequisite-root",
            "fin-410-corequisite",
            CourseRuleExpressionNodeType.COMPLETED_COURSE,
            display_order=0,
            referenced_course_key="FIN-411",
            text_value="Mock FIN 411 must be enrolled concurrently with FIN 410.",
        ),
        expression_node(
            "fin-450-prerequisite-root",
            "fin-450-prerequisite",
            CourseRuleExpressionNodeType.COMPLETED_COURSE,
            display_order=0,
            referenced_course_key="ACTL-300",
            text_value="Mock FIN 450 requires ACTL 300, which this student has not completed.",
        ),
        expression_node(
    ...
    attempts = [
        ...
        StudentCourseAttempt(
            id=seed_uuid("attempt:mock-student-fin-200-completed"),
            student_profile_id=student.id,
    ...
    merge_all(
        ...
        [
            ...
            DevSeedRecord(
                id=seed_uuid("dev-seed-record:mock-course-eligibility"),
                seed_key="mock-course-eligibility",
                label="Phase 4 mock course eligibility source-data seed marker",
                payload={
                    "source_type": SourceType.MOCK.value,
                    "is_official": False,
                    "rules": [
                        "mock prerequisite hard pass",
                        "mock prerequisite hard fail",
                        "mock projected conditional prerequisite",
                        "mock corequisite concurrent enrollment",
                        "mock section permission separate from seats",
                    ],
            ...
            DevSeedRecord(
                id=seed_uuid("dev-seed-record:mock-semester-schedule"),
                seed_key="mock-semester-schedule",
                label="Phase 6A/6B mock semester schedule source-data seed marker",
                payload={
                    "source_type": SourceType.MOCK.value,
                    "is_official": False,
                    "schedule_cases": [
                        "multiple sections for the same course",
                        "two sections with a time conflict",
                        "Friday section removable by hard constraint",
                        "online asynchronous section",
                        "hybrid permission-required section",
                        "lecture plus lab section",
                        "closed informational section",
                        "conditional eligibility section",
                        "course with no sections",
                        "compact and spread-out alternatives",
                        "near-duplicate sections for diversity ranking",
                        "morning versus afternoon options",
                        "online versus in-person alternatives",
                        "required and excluded section preference demos",
                        "no feasible schedule unless a hard constraint is relaxed",
